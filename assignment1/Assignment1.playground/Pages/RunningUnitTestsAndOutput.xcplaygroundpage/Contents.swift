...
To run unit tests select "Test" from the "Product" menu in Xcode. This will compile and run the unit test bundles that
you have been enabling as you work. If any of your implementation is not correct, you may see compile error or test
failures in your project, you should inspect any errors and failures and correct any problems they indicate. If your
implementation is finished and correct, all 38 unit tests should pass.

# Example Output

Here is some example output from the solution implementation for your reference. Your output should be identical to
this output, with the exception of the elements that are influenced by random variation (even times and whether or not a
participant succeeds or fails).
